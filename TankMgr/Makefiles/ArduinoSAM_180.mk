...
#
#
# Last update: 08 Sep 2017 release 8.0.3
...
BUILD_CORE       := sam
SUB_PLATFORM     := sam
PLATFORM_TAG      = ARDUINO=10807 ARDUINO_ARCH_SAM EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
