...
#
#
# Last update: 10 Dec 2018 release 10.3.4
...
BUILD_CORE       := samd
SUB_PLATFORM     := samd
PLATFORM_TAG      = ARDUINO=10807 ARDUINO_ARCH_SAMD EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS))
...
COMMAND_LINK    = $(CC) -L$(OBJDIR) $(LDFLAGS) $(OUT_PREPOSITION)$@ -L$(OBJDIR) $(LOCAL_OBJS) -Wl,--start-group -L$(CMSIS_PATH)/CMSIS/Lib/GCC/ -larm_cortexM0l_math -lm $(TARGET_A) -Wl,--end-group
