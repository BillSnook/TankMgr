...
#
#
# Last update: 28 Dec 2018 release 10.4.0
...
ifeq ($(BUILD_CORE),c2000)
		...
		@echo Environment
		@echo . $$(defaults read /System/Library/PrivateFrameworks/ServerInformation.framework/Versions/A/Resources/English.lproj/SIMachineAttributes.plist $$(sysctl hw.model | cut -d: -f2) | grep marketingModel | cut -d\" -f2-3 | sed 's/\\//g')
