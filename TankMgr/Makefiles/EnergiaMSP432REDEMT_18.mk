...
#
#
# Last update: 16 Oct 2018 release 10.1.5
...
# ----------------------------------
#
REQUIRED_ENERGIA_MSP432_RED_EMT_RELEASE = 5.23.1
...
PLATFORM_TAG      = ENERGIA=$(ENERGIA_RELEASE) ARDUINO=$(ARDUINO_RELEASE) EMBEDXCODE=$(RELEASE_NOW) ENERGIA_ARCH_MSP432R ENERGIA_$(call PARSE_BOARD,$(BOARD_TAG),build.board) ENERGIA_MT $(filter __%__ ,$(GCC_PREPROCESSOR_DEFINITIONS)) CORE_VERSION=5231 _DEFAULT_SOURCE

APPLICATION_PATH := $(ENERGIA_18_PATH)

ENERGIA_RELEASE   := 10806
ARDUINO_RELEASE   := 10806
...
CPPFLAGS    += $(addprefix -D, xdc_target_types__=gnu/targets/arm/std.h xdc_target_name__=M4F xdc_cfg__xheader__=\"configPkg/package/cfg/energia_pm4fg.h\" xdc__nolocalstring=1)
...
LDFLAGS     += $(addprefix -L, $(BUILDS_PATH) $(INCLUDE_LIBS))
...
# Files to be specified explicitely for linking
#
SPECIAL_OBJS     = $$(find $(BUILDS_PATH) -name wiring.c.o)
...
COMMAND_LINK = $(CXX) $(OUT_PREPOSITION)$@ $(VARIANT_OBJS) $(SPECIAL_OBJS) $(LOCAL_OBJS) $(TARGET_A) $(LDFLAGS)
