...
#
#
# Last update: 14 Nov 2018 release 10.2.7
...
#
PLATFORM         := esp8266
PLATFORM_TAG      = ARDUINO=10807 ARDUINO_ARCH_ESP8266 EMBEDXCODE=$(RELEASE_NOW) ARDUINO_$(BUILD_BOARD) ESP8266 ARDUINO_BOARD=\"$(BUILD_BOARD)\"
...
#
BOARD_TAGS_LIST   = $(BOARD_TAG) $(BOARD_TAG1) $(BOARD_TAG2) $(BOARD_TAG3) $(BOARD_TAG4) $(BOARD_TAG5) $(BOARD_TAG6)
...
#$(info INCLUDE_LWIPVARIANT $(INCLUDE_LWIPVARIANT))
#$(info CPPFLAGS_LWIPVARIANT $(CPPFLAGS_LWIPVARIANT))
#$(info L_FLAGS_LWIPVARIANT $(L_FLAGS_LWIPVARIANT))
