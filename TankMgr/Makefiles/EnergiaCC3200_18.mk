...
#
#
# Last update: 15 Oct 2018 release 10.1.4
...
PLATFORM_TAG      = ARDUINO=$(ARDUINO_RELEASE) ENERGIA=$(ENERGIA_RELEASE) ENERGIA_$(call PARSE_BOARD,$(BOARD_TAG),build.board) ENERGIA_ARCH_CC3200 EMBEDXCODE=$(RELEASE_NOW)
...
TOOL_CHAIN_PATH   = $(ENERGIA_CC3200_PATH)/tools/arm-none-eabi-gcc/$(ENERGIA_CC3200_GCC_ARM_RELEASE)/bin
...
## Was: Required for correct sprintf()
## Now: Avoid for correct sprintf()
##
##FIRST_O_IN_A     = $$(find $(BUILDS_PATH) -name wiring.c.o)
...
CPPFLAGS    += -nostdlib --param max-inline-insns-single=500
...
#
CXXFLAGS    = -fno-rtti -fno-exceptions -std=gnu++11 -fno-threadsafe-statics
...
LDFLAGS     += -mfloat-abi=soft -mabi=aapcs
...
# Link command
#
COMMAND_LINK = $(CXX) $(LDFLAGS) $(OUT_PREPOSITION)$@ -LBuilds -Wl,--start-group $(SYSTEM_OBJS) $(LOCAL_OBJS) $(TARGET_A) -Wl,--end-group $(CORE_A) -lm -lc -lgcc
